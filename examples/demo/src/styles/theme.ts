...
export const theme: Theme = {
    ...
    fonts: {
        ...
        boldCondensed: 'Roboto Condensed, sans-serif',
        regular: 'Roboto, sans-serif',
        regularItalic: 'Roboto, sans-serif',
        semiBold: 'Roboto, sans-serif',
        semiBoldCondensed: 'Roboto Condensed, sans-serif',
        regularCondensed: 'Roboto Condensed, sans-serif',
    },
};
